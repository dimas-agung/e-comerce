            ...
            (function(t) {
                (function() {
                    ...
                    const e = t => "[object Object]" === Object.prototype.toString.call(t),
                        ...
                        c = t => t ? t.trim().split(" ").map((t => `.${t}`)).join("") : null,
                        h = (t, e) => {
                    ...
                    function b(t, e, s) {
                        ...
                        switch (o) {
                            ...
                            case s._const.addTextElement:
                                var u;
                                if (c = (u = r.slice()).splice(u.length - 1, 1)[0], n = s.document.createTextNode(e[s._const.value]), !(i = g(t, u)).childNodes) return !1;
                    ...
                    var _ = function(t) {
                        ...
                        D = function(t) {
                            return delete t.outerDone, delete t.innerDone, delete t.valueDone, !t.childNodes || t.childNodes.every(D)
                        },
                        x = function(t) {
                    ...
                    function S(t, e) {
                        ...
                        return f(t, "Text", "Comment") ? s.data = t.data : (t.attributes && t.attributes.length > 0 && (s.attributes = {}, Array.prototype.slice.call(t.attributes).forEach((function(t) {
                            return s.attributes[t.name] = t.value
                        }))), t.childNodes && t.childNodes.length > 0 && (s.childNodes = [], Array.prototype.slice.call(t.childNodes).forEach((function(t) {
                            return s.childNodes.push(S(t, e))
                        }))), e.valueDiffing && (f(t, "HTMLTextAreaElement") && (s.value = t.value), f(t, "HTMLInputElement") && ["radio", "checkbox"].includes(t.type.toLowerCase()) && void 0 !== t.checked ? s.checked = t.checked : f(t, "HTMLButtonElement", "HTMLDataElement", "HTMLInputElement", "HTMLLIElement", "HTMLMeterElement", "HTMLOptionElement", "HTMLProgressElement", "HTMLParamElement") && (s.value = t.value), f(t, "HTMLOptionElement") && (s.selected = t.selected))), s
                    }
                    ...
                    var A = {
                        ...
                        P = function(t, e) {
                            var s = {
                                ...
                                i = !1,
                                n = t.match(/<\/?([^\s]+?)[/\s>]/);
                            if (n && (s.nodeName = e || "svg" === n[1] ? n[1] : n[1].toUpperCase(), (A[n[1]] || "/" === t.charAt(t.length - 2)) && (i = !0), s.nodeName.startsWith("!--"))) {
                                var a = t.indexOf("--\x3e");
                                return {
                                    type: "comment",
                                    node: {
                            ...
                            return t.replace(k, (function(r, l) {
                                ...
                                if ((!d || s.voidElement) && (n > -1 && (s.voidElement || e.caseSensitive && s.node.nodeName === r.slice(2, -1) || !e.caseSensitive && s.node.nodeName.toUpperCase() === r.slice(2, -1).toUpperCase()) && --n > -1 && ("svg" === s.node.nodeName && (o = !1), s = a[n]), "<" !== u && u)) {
                                    var b = -1 === n ? i : a[n].node.childNodes || [],
                                        v = t.indexOf("<", h);
                                    m = L(t.slice(h, -1 === v ? void 0 : v)), b.push({
                                        nodeName: "#text",
                                        data: m
                                    })
                                }
                        ...
                        H = function() {
                            ...
                            return t.prototype.init = function() {
                                ...
                                do {
                                    ...
                                    0 === (s = this.findNextDiff(t, e, [])).length && (M(t, e) || (this.foundAll ? console.error("Could not find remaining diffs!") : (this.foundAll = !0, D(t), s = this.findNextDiff(t, e, [])))), s.length > 0 && (this.foundAll = !1, this.tracker.add(s), C(t, s, this.options))
                                } while (s.length > 0);
                                ...
                                if (t.nodeName !== e.nodeName) {
                                    ...
                                    return [(new p).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, x(t)).setValue(this.options._const.newValue, x(e)).setValue(this.options._const.route, s)]
                                }
                                if (s.length && this.options.diffcap < Math.abs((t.childNodes || []).length - (e.childNodes || []).length)) return [(new p).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, x(t)).setValue(this.options._const.newValue, x(e)).setValue(this.options._const.route, s)];
                                ...
                                if (!this.options.maxChildCount || a < this.options.maxChildCount) {
                                    var d = Boolean(t.subsets && t.subsetsAge--),
                                        c = d ? t.subsets : t.childNodes && e.childNodes ? function(t, e) {
                                                    ...
                                                    var t = function(t, e, s, i) {
                                                        ...
                                                        for (var h = 0; h < o; h++)
                                                            for (var u = t[h], p = 0; p < r; p++) {
                                                                var f = e[p];
                                                                s[h] || i[p] || !O(u, f, d, c) ? l[h + 1][p + 1] = 0 : (l[h + 1][p + 1] = l[h][p] ? l[h][p] + 1 : 1, l[h + 1][p + 1] >= n && (n = l[h + 1][p + 1], a = [h + 1, p + 1]))
                                                            }
                                                        return 0 !== n && {
                                                            oldValue: a[0] - n,
                                                            newValue: a[1] - n,
                                ...
                                for (var a, o, r, l, d, c = function(t, e, s) {
                                    ...
                                    }(t, e, s), h = c.gaps1, u = c.gaps2, f = t.childNodes.slice(), m = e.childNodes.slice(), g = Math.min(h.length, u.length), b = [], v = 0, w = 0; v < g; w += 1, v += 1)
                                    if (!n || !0 !== h[v] && !0 !== u[v])
                                        if (!0 === h[w])
                                                    ...
                                                    if (l.data !== m[v].data) {
                                                        for (var _ = w; f.length > _ + 1 && "#text" === f[_ + 1].nodeName;)
                                                            if (_ += 1, m[v].data === f[_].data) {
                                                                d = !0;
                                                                break
                                                            } d || b.push((new p).setValue(this.options._const.action, this.options._const.modifyTextElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.oldValue, l.data).setValue(this.options._const.newValue, m[v].data))
                                                    }
                                                } else b.push((new p).setValue(this.options._const.action, this.options._const.removeTextElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.value, l.data)), h.splice(w, 1), f.splice(w, 1), g = Math.min(h.length, u.length), w -= 1, v -= 1;
                                else !0 === u[v] ? b.push((new p).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, x(l)).setValue(this.options._const.newValue, x(m[v])).setValue(this.options._const.route, i.concat(w))) : (b.push((new p).setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.element, x(l))), h.splice(w, 1), f.splice(w, 1), g = Math.min(h.length, u.length), w -= 1, v -= 1);
                                else if (!0 === u[v]) "#text" === (l = m[v]).nodeName ? (b.push((new p).setValue(this.options._const.action, this.options._const.addTextElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.value, l.data)), h.splice(w, 0, !0), f.splice(w, 0, {
                                    nodeName: "#text",
                                    data: l.data
                                }), g = Math.min(h.length, u.length)) : (b.push((new p).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.element, x(l))), h.splice(w, 0, !0), f.splice(w, 0, x(l)), g = Math.min(h.length, u.length));
                                else if (h[w] !== u[v]) {
                                    if (b.length > 0) return b;
                                    if (r = s[h[w]], (o = Math.min(r.newValue, f.length - r.length)) !== r.oldValue) {
                                        a = !1;
                    ...
                    const j = (t, e, s, {
                            ...
                            childNodes: t.map(((t, h) => {
                                ...
                                if (p.sortable && o && (!r.length || c) && (p.filter ? f["data-filterable"] = "true" : f["data-sortable"] = "true"), p.headerClass && (f.class = u(f.class, p.headerClass)), s.sort && s.sort.column === h) {
                                    const t = "asc" === s.sort.dir ? i.ascending : i.descending;
                                    f.class = u(f.class, t), f["aria-sort"] = "asc" === s.sort.dir ? "ascending" : "descending"
                                } else s.filters[h] && (f.class = u(f.class, i.filterActive));
                                if (s.widths[h] && !d) {
                                ...
                                return {
                                    nodeName: "TH",
                                    attributes: f,
                                    childNodes: !a && !r.length || c ? p.sortable && o ? [{
                                        nodeName: "BUTTON",
                                        attributes: {
                        ...
                        q = (t, e, s, i, n, a, {
                            ...
                            const D = {
                                ...
                                childNodes: [{
                                    ...
                                    childNodes: s.map((({
                                        ...
                                        const s = {
                                            ...
                                            childNodes: t.cells.map(((t, s) => {
                                                ...
                                                const r = {
                                                    ...
                                                    childNodes: "html" === a.type ? t.data : [{
                                                        nodeName: "#text",
                                                        data: o(t)
                                                    }]
                                                };
                                                if (d || c || !n.widths[s] || v || (r.attributes.style = u(r.attributes.style, `width: ${n.widths[s]}%;`)), a.cellClass && (r.attributes.class = u(r.attributes.class, a.cellClass)), a.render) {
                                        ...
                                        if (e === a && (s.attributes.class = u(s.attributes.class, r.cursor)), g) {
                                            const i = g(t, s, e);
                                            if (i) {
                                                if ("string" != typeof i) return i;
                                                {
                            ...
                            if (D.attributes.class = u(D.attributes.class, r.table), d || c || _) {
                                const t = j(e, i, n, {
                                    classes: r,
                                    hiddenHeader: l,
                                    sortable: p,
                    ...
                    var B = F({
                            ...
                            var M = function() {
                                    function m(t) {
                                        this.$L = N(t.locale, null, !0), this.parse(t), this.$x = this.$x || t.x || {}, this[_] = !0
                                    }
                                    var g = m.prototype;
                                    return g.parse = function(t) {
                                        ...
                                        var s = this,
                                            ...
                                            u = x.p(t),
                                            p = function(t, e) {
                                                var i = x.w(s.$u ? Date.UTC(s.$y, e, t) : new Date(s.$y, e, t), s);
                                                return d ? i : i.endOf(o)
                                            },
                                            f = function(t, e) {
                                                return x.w(s.toDate()[t].apply(s.toDate("s"), (d ? [0, 0, 0, 0] : [23, 59, 59, 999]).slice(e)), s)
                                            },
                                            m = this.$W,
                                            g = this.$M,
                                            b = this.$D,
                                        ...
                                        var p = x.p(d),
                                            f = function(t) {
                                                var e = D(u);
                                                return x.w(e.date(e.date() + Math.round(t * s)), u)
                                            };
                            ...
                            }, D.locale = N, D.isDayjs = y, D.unix = function(t) {
                                return D(1e3 * t)
                    ...
                    const z = (t, e) => {
                            ...
                            if (e) switch (e) {
                                case "ISO_8601":
                                    ...
                                    break;
                                case "RFC_2822":
                                    s = B(t.slice(5), "DD MMM YYYY HH:mm:ss ZZ").unix();
                                    break;
                                case "MYSQL":
                                    s = B(t, "YYYY-MM-DD hh:mm:ss").unix();
                                    break;
                                case "UNIX":
                                    s = B(t).unix();
                                    break;
                        ...
                        J = (t, e) => {
                            ...
                            switch (e.type) {
                                case "string":
                                    ...
                                    break;
                                case "date":
                                    e.format && (s.order = z(String(s.data), e.format));
                                    break;
                                case "number":
                        ...
                        Q = (t, e = void 0, s, i, n) => {
                            ...
                            if (t.headings) o.headings = t.headings.map((t => W(t)));
                            ...
                            } else e?.tBodies.length && (o.headings = Array.from(e.tBodies[0].rows[0].cells).map((t => W(""))));
                    ...
                    class Z {
                        ...
                        add(t) {
                            ...
                            if (this.dt.data.headings = this.dt.data.headings.concat([W(t.heading)]), this.dt.data.data.forEach(((e, s) => {
                                    e.cells = e.cells.concat([J(t.data[s], t)])
                                })), this.settings[e] = {
                                    type: t.type || "string",
                                    sortable: !0,
                                    searchable: !0
                        ...
                        sort(t, e = void 0, s = !1) {
                            ...
                            this.dt.data.data.sort(((s, i) => {
                                ...
                                return n ? n.compare(String(l), String(d)) : l < d ? -1 : l > d ? 1 : 0
                            })), this._state.sort = {
                                column: t,
                                dir: e
                    ...
                    class et {
                        ...
                        editCellModal() {
                            const t = this.data.cell,
                                ...
                                i = [`<div class='${this.options.classes.inner}'>`, `<div class='${this.options.classes.header}'>`, `<h4>${this.options.labels.editCell}</h4>`, `<button class='${this.options.classes.close}' type='button' data-editor-cancel>${this.options.labels.closeX}</button>`, " </div>", `<div class='${this.options.classes.block}'>`, `<form class='${this.options.classes.form}'>`, `<div class='${this.options.classes.row}'>`, `<label class='${this.options.classes.label}'>${r(s)}</label>`, `<input class='${this.options.classes.input}' value='${r(o(t))}' type='text'>`, "</div>", `<div class='${this.options.classes.row}'>`, `<button class='${this.options.classes.cancel}' type='button' data-editor-cancel>${this.options.labels.cancel}</button>`, `<button class='${this.options.classes.save}' type='button' data-editor-save>${this.options.labels.save}</button>`, "</div>", "</form>", "</div>", "</div>"].join(""),
                                a = n("div", {
                            ...
                            d.focus(), d.selectionStart = d.selectionEnd = d.value.length, a.addEventListener("click", (t => {
                                const e = t.target;
                                e instanceof Element && (e.hasAttribute("data-editor-cancel") ? (t.preventDefault(), this.options.cancelModal(this) && this.closeModal()) : e.hasAttribute("data-editor-save") && (t.preventDefault(), this.saveCell(d.value)))
                            }))
                        }
                        saveCell(t) {
                            ...
                            t.forEach(((t, e) => {
                                ...
                                if ((!s.hidden || s.hidden && this.options.hiddenColumns) && !this.options.excludeColumns.includes(e)) {
                                    ...
                                    a.insertBefore(n("div", {
                                        ...
                                        html: [`<div class='${this.options.classes.row}'>`, `<label class='${this.options.classes.label}'>${r(s)}</label>`, `<input class='${this.options.classes.input}' value='${r(o(t))}' type='text'>`, "</div>"].join("")
                                    }), a.lastElementChild)
                                }
                        ...
                        saveRow(t, e) {
                            ...
                            this.data = {}, this.dt.update(!0), this.closeModal(), this.editing = !1, this.dt.emit("editable.save.row", n, s, e)
                        }
                        openModal() {
                        ...
                        rowRender(t, e, s) {
                            return this.data && this.data.rowIndex === s ? (this.editingCell ? e.childNodes[function(t, e) {
                                let s = t,
                                    i = 0;
                    ...
                    class it {
                        ...
                        init() {
                            ...
                            if (!e) {
                                ...
                                s ? s.appendChild(e) : this.dt.wrapperDOM.appendChild(e), this.addedButtonDOM = !0
                            }
                            this.buttonDOM = e, this.containerDOM = n("div", {
                                id: this.options.classes.container
                            }), this.wrapperDOM = n("div", {
                                class: this.options.classes.wrapper
                            }), this.menuDOM = n("ul", {
                    ...
                    s.DataTable = class {
                        ...
                        init() {
                            if (this.initialized || h(this.dom, this.options.classes.table)) return !1;
                            this._virtualDOM = S(this.dom, this.options.diffDomOptions || {}), this._tableAttributes = {
                            ...
                            }), this.rows = new X(this), this.columns = new Z(this), this.data = Q(this.options.data, this.dom, this.columns.settings, this.options.type, this.options.format), this._render(), setTimeout((() => {
                        ...
                        _render() {
                            ...
                            Array.from(this.wrapperDOM.querySelectorAll(i)).forEach((t => {
                        ...
                        _renderPagers() {
                            ...
                            let t = ((t, e, s, i, n) => {
                                let a = [];
                                if (n.firstLast && a.push(K(1, n.firstText, n)), n.nextPrev) {
                                    const e = t ? 1 : s - 1;
                                    a.push(K(e, n.prevText, n, {
                                        hidden: t
                                    }))
                                }
                                let o = [...Array(i).keys()].map((t => K(t + 1, String(t + 1), n, {
                                    active: t === s - 1
                                })));
                                if (n.truncatePager && (o = ((t, e, s, i) => {
                                    ...
                                    const t = e ? i : s + 1;
                                    a.push(K(t, n.nextText, n, {
                                        hidden: e
                                    }))
                                }
                                return n.firstLast && a.push(K(i, n.lastText, n)), {
                                    nodeName: "UL",
                                    attributes: {
                        ...
                        _renderSeparateHeader() {
                            ...
                            if (e.attributes.class = u(e.attributes.class, this.options.classes.table), this.options.tableRender) {
                        ...
                        _paginate() {
                            ...
                            return this._searchQueries.length && (t = [], this._searchData.forEach((e => t.push({
                                ...
                                e && (t = t.filter((t => {
                                    ...
                                    return "function" == typeof e ? e(i.data) : o(i) === e
                                })))
                        ...
                        multiSearch(t) {
                            ...
                            const s = e.map((t => this.columns.settings.map(((e, s) => {
                                ...
                                return ["base", "accent"].includes(n) && (i = i.map((t => t.toLowerCase()))), ["base", "case"].includes(n) && (i = i.map((t => t.normalize("NFD").replace(/\p{Diacritic}/gu, "")))), (e.ignorePunctuation ?? this.options.ignorePunctuation) && (i = i.map((t => t.replace(/[.,/#!$%^&*;:{}=-_`~()]/g, "")))), i
                            }))));
                            this.data.data.forEach(((t, e) => {
                                const i = t.cells.map(((t, e) => {
                                    ...
                                    if (s.length) {
                                        ...
                                        ["base", "accent"].includes(t) && (s = s.toLowerCase()), ["base", "case"].includes(t) && (s = s.normalize("NFD").replace(/\p{Diacritic}/gu, "")), (i.ignorePunctuation ?? this.options.ignorePunctuation) && (s = s.replace(/[.,/#!$%^&*;:{}=-_`~()]/g, ""))
                                    }
                            ...
                            if (Array.isArray(t)) {
                                ...
                                t.forEach(((t, i) => {
                                    ...
                                    Object.entries(t).forEach((([t, s]) => {
                                        const a = e.indexOf(t);
                                        a > -1 ? n[a] = J(s, this.columns.settings[a]) : this.hasHeadings || this.hasRows || 0 !== i || (n[e.length] = J(s, this.columns.settings[e.length]), e.push(t), this.data.headings.push(W(t)))
                                    })), s.push({
                                        cells: n
                                    })
                                }))
                            } else e(t) && (!t.headings || this.hasHeadings || this.hasRows ? t.data && Array.isArray(t.data) && (s = t.data.map((t => {
                                let e, s;
                                return Array.isArray(t) ? (e = {}, s = t) : (e = t.attributes, s = t.cells), {
                                    attributes: e,
                                    cells: s.map(((t, e) => J(t, this.columns.settings[e])))
                                }
                            }))) : this.data = Q(t, void 0, this.columns.settings, this.options.type, this.options.format));
                        ...
                        setMessage(t) {
                            ...
                            if (this._tableFooters.forEach((t => s.childNodes.push(t))), this._tableCaptions.forEach((t => s.childNodes.push(t))), s.attributes.class = u(s.attributes.class, this.options.classes.table), this.options.tableRender) {
                        ...
                        const i = {
                            ...
                            a = t.data.headings.filter(((t, e) => n(e))).map((t => t.text ?? t.data));
                        let r;
                        if (i.selection)
                            if (Array.isArray(i.selection)) {
                                r = [];
                                for (let e = 0; e < i.selection.length; e++) r = r.concat(t.pages[i.selection[e] - 1].map((t => t.row)))
                            } else r = t.pages[i.selection - 1].map((t => t.row));
                        else r = t.data.data;
                        let l = [];
                        if (l[0] = a, l = l.concat(r.map((t => t.cells.filter(((t, e) => n(e))).map((t => o(t)))))), l.length) {
                            let t = "";
                            if (l.forEach((e => {
                                    e.forEach((e => {
                        ...
                        if (i.selection)
                            if (Array.isArray(i.selection)) {
                                a = [];
                                for (let e = 0; e < i.selection.length; e++) a = a.concat(t.pages[i.selection[e] - 1].map((t => t.row)))
                            } else a = t.pages[i.selection - 1].map((t => t.row));
                        else a = t.data.data;
                        const r = a.map((t => t.cells.filter(((t, e) => n(e))).map((t => o(t))))),
                            l = t.data.headings.filter(((t, e) => n(e))).map((t => t.text ?? String(t.data)));
                        if (r.length) {
                            const t = [];
                            r.forEach(((e, s) => {
