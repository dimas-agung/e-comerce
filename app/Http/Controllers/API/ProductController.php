...
class ProductController extends Controller
{
    ...
    function index(Request $request){
        ...
        if ($product_categories_id) {
            # code...
            $product= Product::with(['category','varians.detail','product_varian'])->where('is_active',1)->where('product_categories_id',$product_categories_id)->latest()->get();
            ...
            # code...
            $product= Product::with(['category','varians.detail','product_varian'])->where('is_active',1)->where('id',$products_id)->latest()->first();
